---
description: Provision Wi-Fi credentials to the claude-card device (one-time, via current transport).
---
...
in mDNS as `_claude-card._tcp` and the next daemon restart will pick
